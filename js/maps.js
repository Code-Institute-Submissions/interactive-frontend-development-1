/*function initMap() {
    ...
    var locations = [
        { lat: 35.668477, lng: 139.4606832 },  //Tokyo
        { lat: 40.6971745, lng: -74.5401066 },  // New York
        { lat: -22.9118825, lng: -43.1728965 },  // Rio de Janeiro
...
var markers = [];
var autocomplete;
var countryRestrict = { 'country': 'New York' };
...
function initMap() {
    map = new google.maps.Map(document.getElementById('map'), {
        zoom: countries['New York'].zoom,
        center: countries['New York'].center,
